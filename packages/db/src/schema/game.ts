...
export const games = pgTable("games", {
    ...
    whitePlayerId: uuid("white_player_id").unique().references(() => users.id, { onDelete: 'cascade' }),
    blackPlayerId: uuid("black_player_id").unique().references(() => users.id, { onDelete: 'cascade' }),
    ...
    tournamentId: uuid("tournament_id").unique().references(() => tournaments.id),
